...
statenisland_scores = 
  rest_inspec %>%
  filter(str_detect(action, "re-opened") & boro == "staten island") %>%
  group_by(grade_date) %>%
  filter(str_detect(grade_date, "2017") & grade == "Z")
...
### Chart C: Re-Opened Staten Island Restaurant Scores in 2017
